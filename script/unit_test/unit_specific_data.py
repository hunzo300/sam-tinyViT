...
from script.train_python.train_brats import NpyDataset, show_mask, show_box, MedSAM_Lite, device, args, join
...
def inference_on_npy(data_root, npy_file=None, bbox_shift=20):
    ...
    medsam_lite_checkpoint = "/mnt/sda/minkyukim/pth/tiny-brats/tiny_model_{epoch}.pth"
    ...
    for step, batch in enumerate(dataloader):
        ...
        plt.savefig(f"output_images/inference_output_{img_name}.png", bbox_inches="tight", dpi=300)
        plt.close()
