...
parser.add_argument(
    "-data_root", type=str, default="/mnt/sda/minkyukim/sam_dataset_refined/brats_npy_train_dataset_256image",
    help="Path to the npy data root."
)
parser.add_argument(
    "-pretrained_checkpoint", type=str, default="/home/minkyukim/sam-tinyViT/work_dir/MedSAM/lite_medsam.pth",
...
class NpyDataset(Dataset): 
    ...
    def __getitem__(self, index):
        ...
        # img_padded = self.pad_image(img_256) # (256, 256, 3)
        ...
        # gt = cv2.resize(
        #     gt,
        #     (img_256.shape[1], img_256.shape[0]),
        ...
        return {
            ...
            "original_size": torch.tensor(np.array([img_256.shape[0], img_256.shape[1]])).long()
        }
...
if __name__ == "__main__":
    ...
    for epoch in range(start_epoch + 1, num_epochs):
        ...
        #     "best_loss": best_loss,
        # }
        torch.save(medsam_lite_model.state_dict(), join(f"/mnt/sda/minkyukim/pth/tiny-brats/tiny_model_{epoch}.pth"))
        if epoch_loss_reduced < best_loss:
            print(f"New best loss: {best_loss:.4f} -> {epoch_loss_reduced:.4f}")
            best_loss = epoch_loss_reduced
            # checkpoint["best_loss"] = best_loss
            torch.save(medsam_lite_model.state_dict(), join("/mnt/sda/minkyukim/pth/sam-tutorial_brats/tiny_model_best.pth"))
