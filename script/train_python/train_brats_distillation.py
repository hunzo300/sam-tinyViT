...
parser.add_argument('-i', '--tr_npy_path', type=str,
                    default="/mnt/sda/minkyukim/sam_dataset_refined/brats_npy_train_dataset_256image",
                    help='path to training npy files; two subfolders: gts and imgs')
parser.add_argument('-task_name', type=str, default='MedSAM-Lite')
parser.add_argument('-medsam_checkpoint', type=str,
                    default="/home/minkyukim/sam-tinyViT/work_dir/SAM/sam_vit_b_01ec64.pth",
                    help='path to MedSAM encoder checkpoint')
parser.add_argument('-tinyvit_checkpoint', type=str,
                    default="/home/minkyukim/sam-tinyViT/work_dir/MedSAM/tinyvit_pretrained.pt",
...
for epoch in range(start_epoch, max_epochs):
    ...
    torch.save(student_model.state_dict(), join(f"/mnt/sda/minkyukim/pth/tiny-brats-distill/tiny_model_{epoch}.pth"))
    if epoch_loss < best_loss:
        best_loss = epoch_loss
        torch.save(student_model.state_dict(), join(f"/mnt/sda/minkyukim/pth/tiny-brats-distill/tiny_model_best.pth"))
