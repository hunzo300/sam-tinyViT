...
parser.add_argument('-i', '--tr_npy_path', type=str,
                    default="/mnt/sda/minkyukim/sam_dataset_refined/ivdm_npy_train_dataset_256image",
...
for epoch in range(start_epoch, max_epochs):
    ...
    torch.save(student_model.state_dict(), join(f"/mnt/sda/minkyukim/pth/tiny-ivdm-distill/tiny_model_{epoch}.pth"))
    if epoch_loss < best_loss:
        best_loss = epoch_loss
        torch.save(student_model.state_dict(), join(f"/mnt/sda/minkyukim/pth/tiny-ivdm-distill/tiny_model_best.pth"))
