...
parser.add_argument(
    "-data_root", type=str, default="/mnt/sda/minkyukim/sam_dataset_refined/ivdm_npy_train_dataset_256image",
...
for epoch in range(start_epoch + 1, num_epochs):
    ...
    #     "best_loss": best_loss,
    # }
    torch.save(medsam_lite_model.state_dict(), join("/mnt/sda/minkyukim/pth/tiny-ivdm/tiny_model_{epoch}.pth"))
    if epoch_loss_reduced < best_loss:
        print(f"New best loss: {best_loss:.4f} -> {epoch_loss_reduced:.4f}")
        best_loss = epoch_loss_reduced
        # checkpoint["best_loss"] = best_loss
        torch.save(medsam_lite_model.state_dict(), join("/mnt/sda/minkyukim/pth/tiny-ivdm/tiny_model_best.pth"))
